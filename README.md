...
<details>
  ...
  programming like variables declaration, functions, etc. Then, I learned C, with C came memory management, structs, vectors, etc. And then came
  the great breakthrough, C++ changed my whole life as programmer, it was when I first met OOP and fell in love with it, with C++ I developed even
  more my developers skills, working with OOP, data structures, librarys and started developing my firsts projects.
